...
set_property -dict {PACKAGE_PIN H2 IOSTANDARD LVCMOS33} [get_ports btn_l]

set_property -dict {PACKAGE_PIN J1 IOSTANDARD LVCMOS33} [get_ports btn_d]

set_property -dict {PACKAGE_PIN J5 IOSTANDARD LVCMOS33} [get_ports btn_r]
