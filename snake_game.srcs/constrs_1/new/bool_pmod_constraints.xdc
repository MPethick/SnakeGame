...
# External Buttons via PMODD's lower pins (pins 7-12)
set_property -dict {PACKAGE_PIN L5 IOSTANDARD LVCMOS33} [get_ports btn_u]

set_property -dict {PACKAGE_PIN M4 IOSTANDARD LVCMOS33} [get_ports btn_l]

set_property -dict {PACKAGE_PIN K4 IOSTANDARD LVCMOS33} [get_ports btn_r]

set_property -dict {PACKAGE_PIN L4 IOSTANDARD LVCMOS33} [get_ports btn_d]
